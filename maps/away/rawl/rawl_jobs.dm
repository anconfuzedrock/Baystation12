/datum/job/submap/rawl_tech
	...
	maybe salvage some fuel or spare parts along the way. \
...
/datum/job/submap/rawl_butcher
	title = "Butcher"
	total_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/rawl/butcher
	supervisors = "the whiners back at the outpost."
	info = "The boys are tired of synthmeat and protein drinks, they demand game.  \
	Good excuse to take your 'homely' ship out. Catch meat dead or alive,  \
	maybe find some cleaner along the way. \
	If questioned, your crew works alone. Better, don't act questionable. Dohruk doesn't need publicity."
...
/datum/job/submap/rawl_medic
	...
	info = "The boys are tired of synthmeat and protein drinks, they demand game.  \
	Good excuse to take your 'homely' ship out. Catch meat dead or alive,  \
	maybe salvage some actual medical supplies along the way. \
	If questioned, your crew works alone. Better, don't act questionable. Dohruk doesn't need publicity."
	whitelisted_species = list(SPECIES_UNATHI)
	is_semi_antagonist = TRUE
	min_skill = list(
...
/obj/effect/submap_landmark/spawnpoint/rawl_butcher
	name = "Butcher"
	movable_flags = MOVABLE_FLAG_EFFECTMOVE
...
/decl/hierarchy/outfit/job/rawl/butcher
	name = "Butcher"
